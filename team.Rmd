...
18.
Regarding data, inference is essentially learning how a model to learn and infer about something like trends in the data, whereas prediction would be using a model to input new values and estimate what the outputs resulting from it.
